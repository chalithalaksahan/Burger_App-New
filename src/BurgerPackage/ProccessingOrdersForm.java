...
public class ProccessingOrdersForm extends javax.swing.JFrame {
     ...
     */
    public ProccessingOrdersForm(BurgerList burgerList) {
        initComponents();
   ...
   try {
             String PrepairId = String.format("%d",Burger.PREPARING);
...
//   DefaultTableModel dtm = (DefaultTableModel) tblBurgerDetails.getModel();
 //     dtm.setRowCount(0);
//      Burger[] burgerArray=burgerList.checkStatus(Burger.PREPARING);
